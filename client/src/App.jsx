  ...
  return (
    <div className="app-shell">
      ...
      <section className="donate-section" aria-labelledby="donate-section-title">
        <div className="donate-heading"><h2 id="donate-section-title">♡ Ủng hộ dự án ♡</h2><p>Nếu website hữu ích với bạn, một lời ủng hộ sẽ giúp mình duy trì và phát triển dự án.</p></div>
